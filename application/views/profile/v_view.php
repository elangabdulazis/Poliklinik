  ...
  <div class="row ">
    <div class="col-md-12">
        <div class="card card-widget widget-user">
              ...
              <?php  
              $query = "
              SELECT `tbl_dokter`.*,`tbl_spesialis`.*,`user`.* FROM `tbl_dokter`,`tbl_spesialis`,`user` 
              WHERE `tbl_spesialis`.`kd_spesialis` = `tbl_dokter`.`spesialis` && 
              `tbl_dokter`.`email` = 'iqbal@gmail.com' limit 1
              ";
            $profil = $this->db->query($query)->result_array();
            ?>
              ...
              <div class="widget-user-header bg-info">
                ...
                <h5 class="widget-user-desc"><?= $row['spesialis'];?></h5>
              </div>
              ...
              <div class="card-footer">
                <div class="row">
                  ...
                  <div class="col-sm-4 border-right">
                    <div class="description-block">
                      <h5 class="description-header"><?=$row['noizin'];  ?></h5>
                ...
                <div class="card-body" style="display: block;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>Rp. <label id="tarif"><?= $dokter[0]->tarif ?></label></td>
                    </tr>
                    <tr>

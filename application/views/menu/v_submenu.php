      ...
      <div class="container-fluid">
         ...
         <div class="card">
              <div class="card-header" style="background-color: aqua">
                <h3 class="card-title">Data SubMenu Management</h3>
              ...
              <div class="card-body" style="background-color: #212529; color: white;">
                ...
                <a href="<?= base_url('menu/tambahsubmenu'); ?>" class="btn btn-danger mb-3">Tambah Data</a>
                      ...
                      <?php foreach($submenu as $row) : ?>
                        <tr>
                         ...
                         <td>
                           ...
                           <button type="button" onclick="submit(<?= $row['id']?>)" class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-xl"><i class="fa fa-edit"></i></button>
                           <a href="<?= base_url()?>menu/hapusSubmenu/<?= $row['id']?> " class="btn btn-danger tombol-hapus"><i class="fa fa-trash"></i></a>
                          </td>
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLabel">Update Data SubMenu</h4>
      ...
      <div class="modal-body">
        ...
        <form id="formdata" method="post" action=" <?= base_url().'menu/edit';?> ">

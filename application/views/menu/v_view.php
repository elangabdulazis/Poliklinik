      ...
      <div class="container-fluid">
         ...
         <div class="card">
              ...
              <div class="card-body" style="background-color: #212529; color: white;">
                ...
                <a href="<?= base_url()?>menu/tambah" class="btn btn-danger mb-3">Tambah Data</a>
                      ...
                      <?php foreach($menu as $row) : ?>
                        <tr>
                         ...
                         <td>
                           ...
                           <a href="<?= base_url()?>menu/hapusMenu/<?= $row['id']?> " class="btn btn-danger tombol-hapus"><i class="fa fa-trash"></i></a>
                          </td>
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="formdata" method="post" action=" <?= base_url().'menu/update';?> ">
            ...
            <div class="form-group">
              ...
              <input type="text" name="menu"  class="form-control" id="menu" placeholder="meu">
            </div>

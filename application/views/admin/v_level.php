                      ...
                      <?php foreach($level as $row) : ?>
                        <tr>
                         ...
                         <td>
                           ...
                           <a href="<?= base_url()?>diagnosa/hapus/<?= $row['id']?> " class="btn btn-danger tombol-hapus"><i class="fa fa-trash"></i></a>
                           <a href="<?= base_url('admin/access/'). $row['id'];  ?>" class="btn btn-warning">Access</a>
                          </td>
      ...
      <div class="modal-body">
        ...
        <form id="formdata" method="post" action=" <?= base_url().'diagnosa/update';?> ">
            ...
            <div class="form-group">
              ...
              <input type="text" name="diagnosa"  class="form-control" id="diagnosa" placeholder="Nama Obat">
            </div>
          <div class="form-group">

      ...
      <div class="container-fluid">
         <div class="card">
              ...
              <div class="flash-data" data-flashdata="<?= $this->session->flashdata('flash');?>"></div>
                <a href="<?= base_url()?>labor/tambah" class="btn btn-danger mb-3">Tambah Data</a>
                      ...
                      <?php foreach($lab as $row) : ?>
                        <tr>
                          ...
                          <td>
                           ...
                           <a href="<?= base_url()?>labor/hapusData/<?= $row['no']?> " class="btn btn-danger tombol-hapus"><i class="fa fa-trash"></i></a>
                          </td>
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <div class="flash-data" data-flashdata="<?= $this->session->flashdata('flash');?>"></div>
          <form action="<?=base_url('labor/update') ?>" method="post">
